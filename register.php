...
if (isset($_GET['success']) && empty($_GET['success'])) {
    ...
    <form action="" method="post">
        <ul>
            ...
            <li>
                Password again*:<br>
                <input type="password" name="password_again" style="width: 220px">
            </li>
            <li>
                First name*:<br>
                <input type="text" name="first_name" style="width: 220px">
            </li>
            <li>
                 Last name:<br>
                <input type="text" name="last_name" style="width: 220px">
            </li>
            <li>
                Email*:<br>
            ...
            <li>           
                <input type="submit" value="Register" style="width: 220px">
            </li>       
        </ul>    
    </form>
